...
- 明确本 change 需要遵守 `doc/CUSTOM_INSTRUCTION_SHARED_BASELINE.md` 中冻结的 `.version 7.8` / `sm_90` baseline、reference-model oracle，以及 MMA 首发只承诺 `native-mma-sync` `row.col` 子集的边界。
